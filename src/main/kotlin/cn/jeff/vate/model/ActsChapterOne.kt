...
object ActsChapterOne : ArticleExercise() {

	override val topic = "使徒行传第一章"
	...
	override val article = """
		...
		1:3 After his suffering, he showed himself to these men 
		...
		1:4 On one occasion, while he was eating with them, 
		...
		1:5 For John baptized with water, but in a few days 
		you will be baptized with the Holy Spirit."
		1:6 So when they met together, they asked him, 
		"Lord, are you at this time going to restore the kingdom to Israel?"
		1:7 He said to them: "It is not for you to know the times 
		...
		1:10 They were looking intently up into the sky 
		as he was going, when suddenly 
		...
		1:15 In those days Peter stood up among the believers 
		(a group numbering about a hundred and twenty)
		1:16 and said, "Brothers, the Scripture had to be fulfilled 
		...
		1:21 Therefore it is necessary to choose one of the men 
		who have been with us the whole time 
		the Lord Jesus went in and out among us,
		1:22 beginning from John's baptism to the time 
		when Jesus was taken up from us. For one of these 
		must become a witness with us of his resurrection."
		1:23 So they proposed two men: Joseph called Barsabbas 
		(also known as Justus) and Matthias.
		1:24 Then they prayed, "Lord, you know everyone's heart. 
		Show us which of these two you have chosen
		1:25 to take over this apostolic ministry, 
		which Judas left to go where he belongs."
		1:26 Then they cast lots, and the lot fell to Matthias; 
